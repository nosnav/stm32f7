 ...
 * \par Set your target
 * 
 * \note   If you follow my description in @ref DISCO library on how to select your used board, then this library will automatically select your "target".
 *
 ...
 */
uint8_t SDRAM_InitCustomPinsCallback(uint16_t AlternateFunction);
