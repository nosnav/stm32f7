...
void DMA_Init(DMA_Stream_TypeDef* Stream, DMA_HandleTypeDef* HDMA) {	
	/* Init DMA stream */
	if (HDMA) {
		/* Unlock DMA */
		__HAL_UNLOCK(HDMA);
...
void DMA_Start(DMA_HandleTypeDef *hdma, uint32_t Source, uint32_t Destination, uint16_t Length) {
	/* Unlock DMA */
	__HAL_UNLOCK(hdma);
...
__weak void DMA_TransferCompleteHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_TransferCompleteHandler should be implemented in the user file
	*/
}

__weak void DMA_HalfTransferCompleteHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_HalfTransferCompleteHandler should be implemented in the user file
	*/
}

__weak void DMA_TransferErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_TransferErrorHandler should be implemented in the user file
	*/
}

__weak void DMA_DirectModeErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_DirectModeErrorHandler should be implemented in the user file
	*/
}

__weak void DMA_FIFOErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
	/* NOTE: This function should not be modified, when the callback is needed,
            the DMA_FIFOErrorHandler should be implemented in the user file
	*/
}
