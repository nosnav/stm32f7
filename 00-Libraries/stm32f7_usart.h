#ifndef __STM32F7_USART_H
#define __STM32F7_USART_H
#ifdef __cplusplus
 extern "C" {
#endif
 ...
 */
typedef enum {
	USART_PinsPack_1 = 0x00, /*!< Select PinsPack1 from Pinout table for specific USART */
